...
void processCommand(String commandString) {
      ...
      int speedstringindex=incomingstring.indexOf(' ');
      String speedstring=incomingstring.substring(speedstringindex+1);
      ...
      int accelstringindex=incomingstring.indexOf(' ');
      String accelstring=incomingstring.substring(accelstringindex+1);
      ...
      int powerstringindex=incomingstring.indexOf(' ');
      String powerstring=incomingstring.substring(powerstringindex+1);
      //Serial.print(powerstring);
      ...
      stepperx.setAcceleration(acceleration);  // set motor speed 
      int movestringindex=incomingstring.indexOf(' ');
      String movestring=incomingstring.substring(movestringindex+1);
